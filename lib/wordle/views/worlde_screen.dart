...
import 'package:wordle/app/appColors.dart';
...
class _WordleScreenState extends State<WordleScreen> {
  ...
  final List<List<GlobalKey<FlipCardState>>> _flipCardKeys = List.generate(6, (_) => List.generate(5, (_) => GlobalKey<FlipCardState>()),);
